...
#
"""Truncate the drain target before a measured Tier 1 run (plan §5 step 3b).

Ported verbatim from spark-clickhouse-connector benchmarks/scripts/truncate_target.py.
