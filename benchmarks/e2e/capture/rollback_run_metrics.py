...
Ported verbatim from spark-clickhouse-connector benchmarks/scripts/rollback_run_metrics.py.
...
fully recorded (and the DWH export is skipped in those cases). This is the
rollback half of the gating discipline described in PORTING.md.
